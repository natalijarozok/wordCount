...
public class TestInputValuesSource {
    ...
    public static List<TestInput> getTestInputValues() {
    ...
    public static List<TestInput> getBaseTestInputValues() {
        return new ArrayList<TestInput>() {{
            add(new TestInput(Arrays.asList("Mary had a little lamb"), STOP_WORDS_EMPTY, 5, 5, 3.6f, Arrays.asList("Mary", "had", "a", "little", "lamb")));
            add(new TestInput(Arrays.asList("Mary had", "a little", "lamb"), STOP_WORDS_EMPTY, 5, 5, 3.6f, Arrays.asList("Mary", "had", "a", "little", "lamb")));
            add(new TestInput(Arrays.asList("Humpty-Dumpty sat on a wall. Humpty-Dumpty had a great fall."), STOP_WORDS_EMPTY, 10, 8, 4.9f, Arrays.asList("Humpty-Dumpty", "sat", "on", "a", "wall", "Humpty-Dumpty", "had", "a", "great", "fall")));
            add(new TestInput(Arrays.asList("Mary "), STOP_WORDS_EMPTY, 1, 1, 4f, Arrays.asList("Mary")));
            add(new TestInput(Arrays.asList("Mary"), STOP_WORDS_EMPTY, 1, 1, 4f, Arrays.asList("Mary")));
            add(new TestInput(Arrays.asList("Mary- "), STOP_WORDS_EMPTY, 1, 1, 5f, Arrays.asList("Mary-")));
            add(new TestInput(Arrays.asList("Mary-"), STOP_WORDS_EMPTY, 1, 1, 5f, Arrays.asList("Mary-")));
            add(new TestInput(Arrays.asList("- "), STOP_WORDS_EMPTY, 1, 1, 1f, Arrays.asList("-")));
            add(new TestInput(Arrays.asList("-"), STOP_WORDS_EMPTY, 1, 1, 1f, Arrays.asList("-")));
            add(new TestInput(Arrays.asList("Mary 1"), STOP_WORDS_EMPTY, 1, 1, 4f, Arrays.asList("Mary")));
            ...
            add(new TestInput(Arrays.asList("Mary had a little lamb"), STOP_WORDS, 4, 4, 4.25f, Arrays.asList("Mary", "had", "little", "lamb")));
            add(new TestInput(Arrays.asList("Mary had", "a little", "lamb"), STOP_WORDS, 4, 4, 4.25f, Arrays.asList("Mary", "had", "little", "lamb")));
            add(new TestInput(Arrays.asList("Humpty-Dumpty sat on a wall. Humpty-Dumpty had a great fall."), STOP_WORDS, 7, 6, 6.43f, Arrays.asList("Humpty-Dumpty", "sat", "wall", "Humpty-Dumpty", "had", "great", "fall")));
            add(new TestInput(Arrays.asList("Mary "), STOP_WORDS, 1, 1, 4f, Arrays.asList("Mary")));
            add(new TestInput(Arrays.asList("Mary"), STOP_WORDS, 1, 1, 4f, Arrays.asList("Mary")));
            add(new TestInput(Arrays.asList("Mary- "), STOP_WORDS_EMPTY, 1, 1, 5f, Arrays.asList("Mary-")));
            add(new TestInput(Arrays.asList("Mary-"), STOP_WORDS_EMPTY, 1, 1, 5f, Arrays.asList("Mary-")));
            add(new TestInput(Arrays.asList("- "), STOP_WORDS_EMPTY, 1, 1, 1f, Arrays.asList("-")));
            add(new TestInput(Arrays.asList("-"), STOP_WORDS_EMPTY, 1, 1, 1f, Arrays.asList("-")));
            add(new TestInput(Arrays.asList("Mary 1"), STOP_WORDS, 1, 1, 4f, Arrays.asList("Mary")));
            ...
            add(new TestInput(Arrays.asList("Mary had a little lamb"), null, 5, 5, 3.6f, Arrays.asList("Mary", "had", "a", "little", "lamb")));
            add(new TestInput(Arrays.asList("Mary had", "a little", "lamb"), null, 5, 5, 3.6f, Arrays.asList("Mary", "had", "a", "little", "lamb")));
            add(new TestInput(Arrays.asList("Humpty-Dumpty sat on a wall. Humpty-Dumpty had a great fall."), null, 10, 8, 4.9f, Arrays.asList("Humpty-Dumpty", "sat", "on", "a", "wall", "Humpty-Dumpty", "had", "a", "great", "fall")));
            add(new TestInput(Arrays.asList("Mary "), null, 1, 1, 4f, Arrays.asList("Mary")));
            add(new TestInput(Arrays.asList("Mary"), null, 1, 1, 4f, Arrays.asList("Mary")));
            add(new TestInput(Arrays.asList("Mary- "), STOP_WORDS_EMPTY, 1, 1, 5f, Arrays.asList("Mary-")));
            add(new TestInput(Arrays.asList("Mary-"), STOP_WORDS_EMPTY, 1, 1, 5f, Arrays.asList("Mary-")));
            add(new TestInput(Arrays.asList("- "), STOP_WORDS_EMPTY, 1, 1, 1f, Arrays.asList("-")));
            add(new TestInput(Arrays.asList("-"), STOP_WORDS_EMPTY, 1, 1, 1f, Arrays.asList("-")));
            add(new TestInput(Arrays.asList("Mary 1"), null, 1, 1, 4f, Arrays.asList("Mary")));
